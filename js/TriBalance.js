...
function testGetRayToLineSegmentIntersection(WORLD_TRIANGLE_COORDS) {
...
function testTriBalance2to3(WORLD_TRIANGLE_COORDS) {
...
function testInversion(WORLD_TRIANGLE_COORDS) {
...
function testAllTriBalance() {
    testGetRayToLineSegmentIntersection(WORLD_TRIANGLE_COORDS);
    testTriBalance2to3(WORLD_TRIANGLE_COORDS);
    testInversion(WORLD_TRIANGLE_COORDS);
}
